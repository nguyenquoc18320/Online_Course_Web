    ...
    <body>     
        <form action="#"
            ...
            <div class = 'div_menu'>
                ...
                <div id='div_account'>
                    <label id='label_account'>  <i class='fas fa-caret-down'></i></label>               
                </div>
            </div>
